...
const { DeviceStatesEntity } 	= require("../entities/devicestates.entity.js");
...
class DBManager {
    ...
    create(){                        
        this.addEntity(DeviceEntity); 
        this.addEntity(DeviceStatesEntity); 
        this.addEntity(StateEntity); 
        this.addEntity(StatesRecordEntity);    
        this.addEntity(GpsspecEntity);    
        this.addEntity(TracksEntity);    
        this.build();
    }
